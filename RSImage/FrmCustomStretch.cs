...
namespace RSImage
{
    public partial class FrmCustomStretch : Form
    {
        public string Path;
        public Img Image;
        ...
        public FrmCustomStretch(Img Image)
        {
            InitializeComponent();
            this.Image = Image;
        }
        ...
        private void ChangeShowBand(object sender, EventArgs e)
        {
            if (sender == OverviewButton)
            {
                if (OverviewButton.Checked)
                    return;
                else
                {
